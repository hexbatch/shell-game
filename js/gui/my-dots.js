jQuery(function (){
    ...
    function my_dot_hook(hook) {
        try {
            ...
            for(let element_color_key in colors_to_map_for_elements) {
                ...
                da_connects = da_connects.replaceAll(element_color_key,colors_to_map_for_elements[element_color_key]);
            }
            ...
            for(let shell_color_key in colors_to_map_for_shells) {
                ...
                da_connects = da_connects.replaceAll(shell_color_key,colors_to_map_for_shells[shell_color_key]);
            }
    ...
    shell_game_thing.add_event(new ShellGameEventHook(
        ...
        function(hook) {
            ...
            function in_the_meantime() {
                my_dot_hook(hook)
            }
            setTimeout(in_the_meantime,100);
        }
    ));
